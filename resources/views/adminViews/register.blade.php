                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ url('/home') }}">
                            ...
                            <div class="form-group{{ $errors->has('surname') ? ' has-error' : '' }}">
                                <label for="midname" class="col-md-4 control-label">Отчество</label>

                                <div class="col-md-6">
                                    <input id="midname" type="text" class="form-control" name="midname"
                                           value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select required id="role_id" class="form-control" name="role_id">
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                <label for="password" class="col-md-4 control-label">Пароль для входа</label>
